...
class DetailedActivityRecorder
{
    ...
    public static function init(): void
    {
        ...
        try {
            ...
            DetailedLogHelper::logError('DetailedActivityRecorder initialization error', $e);
        }
    }
    ...
    public static function resolveSubmissionId(string $table, string $operation, array $data, array $where): ?int
    {
        try {
            ...
            DetailedLogHelper::logError("resolveSubmissionId error for table {$table}", $e);
            return null;
        }
    }
    ...
    public static function onPublicationEdit(string $hookName, array $params): bool
    {
        try {
            ...
            DetailedLogHelper::logError("Error in {$hookName}", $e);
        }
        return Hook::CONTINUE;
    }
    ...
    public static function onStageAssignmentSaved(StageAssignment $assignment): void
    {
        try {
            ...
            DetailedLogHelper::logError('Error in onStageAssignmentSaved', $e);
        }
    }
    ...
    public static function onStageAssignmentDeleted(StageAssignment $assignment): void
    {
        try {
            ...
            DetailedLogHelper::logError('Error in onStageAssignmentDeleted', $e);
        }
    }
    ...
    public static function onQuerySaved(Query $query): void
    {
        try {
            ...
            DetailedLogHelper::logError('Error in onQuerySaved', $e);
        }
    }
    ...
    public static function onQueryDeleted(Query $query): void
    {
        try {
            ...
            DetailedLogHelper::logError('Error in onQueryDeleted', $e);
        }
    }
    ...
    public static function onQueryParticipantSaved(QueryParticipant $participant): void
    {
        try {
            ...
            DetailedLogHelper::logError('Error in onQueryParticipantSaved', $e);
        }
    }
    ...
    public static function onQueryParticipantDeleted(QueryParticipant $participant): void
    {
        try {
            ...
            DetailedLogHelper::logError('Error in onQueryParticipantDeleted', $e);
        }
    }
    ...
    public static function onNoteSaved(Note $note): void
    {
        try {
            ...
            DetailedLogHelper::logError('Error in onNoteSaved', $e);
        }
    }
    ...
    public static function onNoteDeleted(Note $note): void
    {
        try {
            ...
            DetailedLogHelper::logError('Error in onNoteDeleted', $e);
        }
    }
    ...
    private static function lookupSubmissionFromPublications(array $data, array $where): ?int
    {
        try {
            ...
            DetailedLogHelper::logError('lookupSubmissionFromPublications error', $e);
            return null;
        }
    }
    ...
    public static function lookupSubmissionFromPublicationId(int $publicationId): ?int
    {
        ...
        try {
            ...
            DetailedLogHelper::logError("lookupSubmissionFromPublicationId error for {$publicationId}", $e);
            return null;
        }
    }
    ...
    private static function lookupSubmissionFromAuthor(array $data, array $where): ?int
    {
        try {
            ...
            DetailedLogHelper::logError('lookupSubmissionFromAuthor error', $e);
            return null;
        }
    }
    ...
    public static function lookupSubmissionFromAuthorId(int $authorId): ?int
    {
        ...
        try {
            ...
            DetailedLogHelper::logError("lookupSubmissionFromAuthorId error for {$authorId}", $e);
            return null;
        }
    }
    ...
    private static function lookupSubmissionFromGalley(array $data, array $where): ?int
    {
        try {
            ...
            DetailedLogHelper::logError('lookupSubmissionFromGalley error', $e);
            return null;
        }
    }
    ...
    public static function lookupSubmissionFromGalleyId(int $galleyId): ?int
    {
        ...
        try {
            ...
            DetailedLogHelper::logError("lookupSubmissionFromGalleyId error for {$galleyId}", $e);
            return null;
        }
    }
    ...
    public static function lookupSubmissionFromFileId(int $submissionFileId): ?int
    {
        ...
        try {
            ...
            DetailedLogHelper::logError("lookupSubmissionFromFileId error for {$submissionFileId}", $e);
            return null;
        }
    }
    ...
    public static function lookupSubmissionFromReviewId(int $reviewAssignmentId): ?int
    {
        ...
        try {
            ...
            DetailedLogHelper::logError("lookupSubmissionFromReviewId error for {$reviewAssignmentId}", $e);
            return null;
        }
    }
    ...
    private static function lookupSubmissionFromQuery(array $data, array $where): ?int
    {
        try {
            ...
            DetailedLogHelper::logError('lookupSubmissionFromQuery error', $e);
            return null;
        }
    }
    ...
    public static function lookupSubmissionFromQueryId(int $queryId): ?int
    {
        ...
        try {
            ...
            DetailedLogHelper::logError("lookupSubmissionFromQueryId error for {$queryId}", $e);
            return null;
        }
    }
    ...
    private static function lookupSubmissionFromNote(array $data, array $where): ?int
    {
        try {
            ...
            DetailedLogHelper::logError('lookupSubmissionFromNote error', $e);
            return null;
        }
    }
    ...
    public static function lookupSubmissionFromCitationId(int $citationId): ?int
    {
        ...
        try {
            ...
            DetailedLogHelper::logError("lookupSubmissionFromCitationId error for {$citationId}", $e);
            return null;
        }
    }
    ...
    public static function getRealClientIp(): string
    {
        try {
            ...
            DetailedLogHelper::logError('Error resolving client IP', $e);
    ...
    public static function getRequestBody(): ?string
    {
        try {
            ...
            DetailedLogHelper::logError('Error capturing request body', $e);
            return null;
        }
    }
    ...
    public static function sanitizePayload(mixed $data): mixed
    {
        try {
            ...
            DetailedLogHelper::logError('Error sanitizing payload', $e);
